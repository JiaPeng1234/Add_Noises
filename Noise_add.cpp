...
int main(int argc, char** argv)
{
	...
	string fullPath;
	fullPath = "D:\\12204250-d791c2cd2e43474984b92b51110b36e7.jpg";
	...
	imwrite("D:\\GrayscalePeppers.png", gimage);//Show and save grayscale image
	...
	imwrite("D:\\GaussianNoise.png", gimageClone1);//save Gaussian noise image.
	waitKey(0);
	...
	imwrite("D:\\SaltandPepper.png", gimageClone2);//save Salt and Pepper noise image.
	...
	imwrite("D:\\MeanfilterOnGauss.png", meanDenoisedGaussian);//save meanfilter on Gauss image.
	...
	imwrite("D:\\MeanfilterOnSnP.png", meanDenoisedSnP);//save meanfilter on Salt n Pepper image.
	...
	imwrite("D:\\MedianfilterOnGauss.png", medianDenoisedGaussian);//save medianfilter on Gauss image.
	...
	imwrite("D:\\MedianfilterOnSnP.png", medianDenoisedSnP);//save medianfilter on Salt n Pepper image.
	...
	imwrite("D:\\AdaptiveThresholding.png", adaptive);
